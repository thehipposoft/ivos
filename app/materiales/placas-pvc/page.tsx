...
export default function PlacasPVCPage() {
  return (
    <div className='flex flex-col'>
        ...
        <div className='flex md:flex-row flex-col 2xl:[1300px] w-[85vw] lg:w-[1100px] mx-auto gap-8 mt-16 mb-12'>
        ...
        <div className='flex flex-col-reverse gap-8 lg:gap-0 lg:flex-row w-screen justify-between'>
          ...
          <div className='flex flex-col gap-2 border border-[#DDDDDD] rounded-tl-2xl md:rounded-tl-[55px] pt-4 mx-auto lg:mx-0 w-[80vw] lg:w-[50vw]'>
        ...
        <div className='flex flex-col py-8'>
          ...
          <div className='md:flex grid grid-cols-2 flex-row flex-wrap justify-between lg:w-[85vw] md:w-[65vw] w-[90vw] py-8 mx-auto gap-8'>
            <div className='flex flex-col gap-2 w-fit relative'>
                <div className='relative md:w-[205px] w-[150px] md:h-[205px] h-[150px] overflow-hidden'>
                    <Image src={'/assets/images/materiales/placas-pvc/placas-1.png'} alt='Material Placas PVC' fill className=' object-cover rounded-tl-[45px] rounded-br-[25px]' />
                </div>
                <div className='flex flex-col'>
            ...
            <div className='flex flex-col gap-2 w-fit relative'>
                <div className='relative md:w-[205px] w-[150px] md:h-[205px] h-[150px] overflow-hidden'>
                    <Image src={'/assets/images/materiales/placas-pvc/placas-2.png'} alt='Material Placas PVC' fill className=' object-cover rounded-tl-[45px] rounded-br-[25px]' />
                </div>
                <div className='flex flex-col'>
                  <h5 className='text-[22px] regular'>Placas de PVC</h5>
                  <h5 className='text-[22px] regular'>Simil Piedra</h5>
            ...
            <div className='flex flex-col gap-2 w-fit relative'>
                <div className='relative md:w-[205px] w-[150px] md:h-[205px] h-[150px] overflow-hidden'>
                    <Image src={'/assets/images/materiales/placas-pvc/placas-3.jpg'} alt='Material Placas PVC' fill className=' object-cover rounded-tl-[45px] rounded-br-[25px]' />
                </div>
                <div className='flex flex-col'>
                  <h5 className='text-[22px] regular'>Placas de PVC</h5>
                  <h5 className='text-[22px] regular'>Simil Piedra</h5>
