...
export default function RevestimientoExteriorPage() {
  return (
    <div className='flex flex-col'>
        ...
        <div className='flex flex-col-reverse py-6 md:py-12 lg:py-0 lg:h-screen gap-8 lg:gap-32 lg:flex-row w-screen justify-between md:justify-end items-center'>
            ...
            <div className='flex flex-col gap-2 border border-[#DDDDDD] rounded-tl-2xl md:rounded-tl-[55px] pt-4 mt-12 md:mt-0 mx-auto md:mx-0 w-[85vw] lg:w-[50vw]'>
