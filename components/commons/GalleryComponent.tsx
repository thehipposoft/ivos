...
const GalleryComponent = ({gallery, banner}:GalleryTypes) => {
  ...
  return (
    <div className='lg:h-[700px] h-[500px] lg:w-screen w-[90vw] mx-auto lg:mx-0 2xl:w-[1300px] 2xl:mx-auto relative group'>
        <Image src={banner} alt='Portada de Galeria'  fill className='object-cover rounded-2xl md:rounded-none' />
        <div className='absolute w-full h-full left-0 top-0 bg-black/20 lg:bg-black/40 z-10 lg:group-hover:opacity-100 lg:opacity-0 duration-500 flex justify-center items-center'>
