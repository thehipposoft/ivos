...
const SecondaryHeader = () => {
  ...
  return (
    <div className='hidden lg:block w-screen z-10 top-0 md:py-4'>
        <div className='w-screen '>
            <div className='lg:w-[85vw] md:w-[90vw] 2xl:w-[1300px] flex justify-between mx-auto items-center'>
                <Link href={'/'}>
                  <Image src={'/assets/images/logo-petroleo2.png'} alt='Logo' width={575} height={273} className='md:w-[160px] w-[150px] md:h-[80px]' />
                </Link>
