...
const Novedad = () => {
  ...
  return (
    <div className='h-screen flex items-center gap-20 2xl:w-[1400px] mx-auto'>
        <Image src={'/assets/images/novedad-elipsis.png'} alt='' width={248} height={585} className='object-contain object-left ' />
        <div className='flex md:flex-row flex-col gap-8 md:justify-center items-center md:items-start'>
            <div className='flex flex-col gap-4'>
                <h2 className='uppercase md:text-[80px] text-6xl bluet'>novedad &lt;</h2>
            ...
            <div>
                <h3 className='uppercase md:text-[70px] text-5xl bluet'>smart glass</h3>
