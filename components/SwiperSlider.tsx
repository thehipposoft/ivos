    ...
    return (
        <div>
            <Swiper
                ...
                className='lg:max-w-[1250px] md:max-w-[90vw] mx-auto my-12 cursor-grab md:h-[360px] h-[400px]'
            >
                <div className='flex cursor-grab'>
                    {
                        slides.map((value:any, index:any) => (
                            <SwiperSlide key={index}>
                                <div className='flex flex-col items-center lg:w-[250px] h-[320px] bg-white hover:shadow-xl duration-700 mx-auto'>
                                    <div className={`relative md:w-[300px] w-[340px] min-h-[360px] md:min-h-[320px] group cursor-pointer`}>
                                        <Link href={value.href} target='_blank' className=''>
                                            <Image src={`${value.background}`} fill alt={value.title} objectPosition='center center' objectFit='cover' className='' />
